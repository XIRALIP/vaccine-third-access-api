...
@Component
public class MongoTemplateWriter extends AbstractMongoRouting {

    final String WRITE_SUFFIX = ".write.uri";

    private final ConcurrentHashMap<Object, Object> dataSources = new ConcurrentHashMap<>();

    public MongoTemplateWriter() {
    ...
    protected void initDataSources() {
        ...
        for (ProvinceEnum provinceEnum : ProvinceEnum.values()) {
            ...
            String uriKey = PREFIX + provinceEnum.getProvinceAlphabetic().toLowerCase() + WRITE_SUFFIX;
